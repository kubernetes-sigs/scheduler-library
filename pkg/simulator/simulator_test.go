...
import (
	...
	"sigs.k8s.io/scheduler-library/pkg/upstreamsync/testutils"
)
...
func TestOutOfTreePluginFactoryCalledPerProfileMap(t *testing.T) {
	t.Skip("temporarily disabled: waiting for issue https://github.com/kubernetes-sigs/scheduler-library/issues/31")
